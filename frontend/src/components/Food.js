...
const Food = ({ selectedDay }) => {
  ...
  return (
    <div className="flex-grow bg-green-200 p-8">
      <div className="grid grid-cols-4 gap-4">
        <div className="bg-gray-50 rounded-lg p-4 shadow">
          <h3 className="text-green-500 font-semibold text-lg">Breakfast</h3>
          <p className="text-gray-400 text-sm">06:30 - 08:00</p>
        ...
        <div className="bg-gray-50 rounded-lg p-4 shadow">
          <h3 className="text-green-500 font-semibold text-lg">Lunch</h3>
          <p className="text-gray-400 text-sm">12:30 - 14:30</p>
          <ul className="mt-4 space-y-2">
        ...
        <div className="bg-gray-50 rounded-lg p-4 shadow">
          <h3 className="text-green-500 font-semibold text-lg">Evening Snacks</h3>
          <p className="text-gray-400 text-sm">16:30 - 17:30</p>
          <ul className="mt-4 space-y-2">
        ...
        <div className="bg-gray-50 rounded-lg p-4 shadow">
          <h3 className="text-green-500 font-semibold text-lg">Dinner</h3>
          <p className="text-gray-400 text-sm">19:30 - 21:00</p>
          <ul className="mt-4 space-y-2">
