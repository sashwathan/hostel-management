  ...
  return (
    <div className='max-w-[1640px] mx-auto flex justify-between items-center p-4'>
       ...
       <div  className={nav ? 'bg-white fixed w-[300px] duration-300 h-screen z-10 top-0 left-0' : 'bg-white fixed w-[300px] duration-300 h-screen z-10 top-0 left-[-100%]'}>
        ...
        <ul>
            <li onClick={()=>{navigate("/")}} className='text-xl py-4 flex ml-4 cursor-pointer'><FaHouseChimneyUser size={25}  className='mr-4 '/>Home</li>
            <li onClick={()=>{navigate("/displaymenu")}} className='text-xl py-4 flex ml-4 cursor-pointer'><FaBowlFood  size={25}  className='mr-4 '/>Food</li>
            <li onClick={()=>{navigate("/payments")}} className='text-xl py-4 flex ml-4 cursor-pointer'><FaWallet  size={25}  className='mr-4 '/> Payments</li>
            <li onClick={()=>{navigate("/faculty")}} className='text-xl py-4 flex ml-4 cursor-pointer'><FaStar size={25} onClick={()=>{navigate("/faculty")}} className='mr-4 '/> Faculty</li>
            <li onClick={()=>{navigate("/contactus")}} className='text-xl py-4 flex ml-4 cursor-pointer'><AiOutlineQuestion size={25}  className='mr-4 '/> Contact us</li>
